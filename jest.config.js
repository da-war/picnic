module.exports = {
  ...
  collectCoverageFrom: ['src/**/*.{js,jsx,ts,tsx}', '!src/**/*.d.ts' , '!src/navigation/*.{js,jsx,ts,tsx}','!src/utils/*.{js,jsx,ts,tsx}','!src/api/*.{js,jsx,ts,tsx}','!src/redux/epics/*.{js,jsx,ts,tsx}','!src/screens/HomeScreen.tsx',],
  globals: {
    'ts-jest': {
      babelConfig: true,
    },
